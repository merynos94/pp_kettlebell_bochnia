    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tgu_weight_1", models.FloatField(blank=True, default=0, null=True)),
                ("tgu_weight_2", models.FloatField(blank=True, default=0, null=True)),
                ("tgu_weight_3", models.FloatField(blank=True, default=0, null=True)),
                (
